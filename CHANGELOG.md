...
- **General**: Fix ScaledObject with names longer than 63 characters failing to create HPA due to label value limit ([#6998](https://github.com/kedacore/keda/issues/6998))
